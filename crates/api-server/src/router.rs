...
pub fn build_router(state: Arc<ApiServerState>, console_dir: Option<&Path>) -> Router {
    ...
    let mut protected_routes = Router::new()
        ...
        .route(
            ...
            get(handlers::deployment::get_scale)
                .put(handlers::deployment::update_scale)
                .patch(handlers::deployment::patch_scale),
        )
        ...
        .route(
            ...
            get(handlers::certificates::get_certificate_signing_request_status)
                ...
                .patch(handlers::certificates::patch_certificate_signing_request_status),
        )
        .route(
