...
pub use pod::{
    ...
    PodAffinityTerm, PodAntiAffinity, PodCondition, PodIP, PodSchedulingGate, PodSecurityContext,
    PodSpec, PodStatus, PreferredSchedulingTerm, Probe, ProjectedVolumeSource,
