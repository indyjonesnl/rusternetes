...
<!-- Vanilla module swap: one rusternetes component at a time inside an otherwise
     ...
     nightly run (docs/testing/vanilla-module-swap.md). -->
[![vanilla kubelet](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Findyjonesnl%2Frusternetes%2Fbadges%2Fvanilla-swap-kubelet.json)](https://github.com/indyjonesnl/rusternetes/actions/workflows/vanilla-swap-kubelet.yml)

[![vanilla api-server](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Findyjonesnl%2Frusternetes%2Fbadges%2Fvanilla-swap-api-server.json)](https://github.com/indyjonesnl/rusternetes/actions/workflows/vanilla-swap-api-server.yml)

[![vanilla scheduler](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Findyjonesnl%2Frusternetes%2Fbadges%2Fvanilla-swap-scheduler.json)](https://github.com/indyjonesnl/rusternetes/actions/workflows/vanilla-swap-scheduler.yml)

[![vanilla controller-manager](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Findyjonesnl%2Frusternetes%2Fbadges%2Fvanilla-swap-controller-manager.json)](https://github.com/indyjonesnl/rusternetes/actions/workflows/vanilla-swap-controller-manager.yml)

[![vanilla kube-proxy](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Findyjonesnl%2Frusternetes%2Fbadges%2Fvanilla-swap-kube-proxy.json)](https://github.com/indyjonesnl/rusternetes/actions/workflows/vanilla-swap-kube-proxy.yml)

<!-- Third-party operator smoke: cert-manager installs and reconciles end-to-end
     on the full rusternetes stack (scripts/run-cert-manager-smoke.sh). -->
[![cert-manager smoke](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Findyjonesnl%2Frusternetes%2Fbadges%2Fcert-manager-smoke.json)](https://github.com/indyjonesnl/rusternetes/actions/workflows/cert-manager-smoke.yml)
